...
$CC ../ini.c -DINI_MAX_LINE=20 unittest.c -DINI_STOP_ON_FIRST_ERROR=1 -o unittest_multi_max_line_stop_on_first_error
./unittest_multi_max_line_stop_on_first_error > baseline_multi_max_line_stop_on_first_error.txt
rm -f unittest_multi_max_line_stop_on_first_error
